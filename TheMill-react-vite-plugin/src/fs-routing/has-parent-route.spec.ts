...
const routes = [
  {
    ...
    fullPath:
      '/TheMill/packages/TheMill-fs-router-vite-plugin/tests/generator/multi-level-root/routes/posts/[post].tsx',
  ...
  },
  {
    ...
    fullPath:
      '/TheMill/packages/TheMill-fs-router-vite-plugin/tests/generator/multi-level-root/routes/posts/__layout.tsx',
  ...
  },
  {
    filePath: 'index.tsx',
    fullPath:
      '/TheMill/packages/TheMill-fs-router-vite-plugin/tests/generator/multi-level-root/routes/index.tsx',
    routePath: '/',
    variableName: 'Index',
    path: '/',
    cleanedPath: '/',
  },
  {
    ...
    fullPath:
      '/TheMill/packages/TheMill-fs-router-vite-plugin/tests/generator/multi-level-root/routes/posts/my-post.tsx',
