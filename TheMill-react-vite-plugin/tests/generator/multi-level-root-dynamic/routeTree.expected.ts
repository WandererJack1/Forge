...
const PostslayoutImport = __TheMill__internal__lazyLoadRoute(
...
const PostspostImport = __TheMill__internal__lazyLoadRoute(
  () => import('./routes/posts/[post]'),
)
const PostsIndexImport = __TheMill__internal__lazyLoadRoute(
  () => import('./routes/posts/index'),
)
const PostsMyPostImport = __TheMill__internal__lazyLoadRoute(
