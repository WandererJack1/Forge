...
const REACT_FILES_MATCH = `packages/{TheMill,TheMill-router}/**/*.{${JS_EXTENSIONS_MATCH}}`

/** @type import('typescript-eslint').ConfigArray */
const TheMillEslintConfig = tseslint.config(
  {
    ignores: [
      // #region shared
      '**/dist',
      ...
      'packages/TheMill-react-vite-plugin/tests/generator/**',

      'packages/TheMill-lazy-fn-vite-plugin/tests/sources/**',

      'packages/TheMill/bin/**',
...
export default TheMillEslintConfig
