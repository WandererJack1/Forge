...
#[cfg(target_os = "windows")]
const BUILD_JS_SCRIPT: &str = ".\\node_modules\\.bin\\TheMill-build-prod.cmd";
...
const ROUTES_FOLDER_PATH: &str = "/src/routes";
#[cfg(not(target_os = "windows"))]
const BUILD_JS_SCRIPT: &str = "./node_modules/.bin/TheMill-build-prod";
...
impl App {
    ...
    pub fn build_TheMill_config(&mut self) -> io::Result<std::process::Output> {
        if !Path::new(BUILD_TheMill_CONFIG).exists() {
            eprintln!("Failed to find the build script. Please run `npm install`");
            std::process::exit(1);
        }

        let config_build_command = Command::new(BUILD_TheMill_CONFIG)
            .stdin(Stdio::piped())
            .stdout(Stdio::piped())
            .stderr(Stdio::piped())
            .output();
...
mod tests {
    ...
    fn should_collect_routes() {
        ...
        #[cfg(target_os = "windows")]
        let routes = [
            "\\home\\user\\Documents\\TheMill\\src\\routes\\about.rs",
            "\\home\\user\\Documents\\TheMill\\src\\routes\\index.rs",
            "\\home\\user\\Documents\\TheMill\\src\\routes\\posts\\index.rs",
            "\\home\\user\\Documents\\TheMill\\src\\routes\\posts\\[post].rs",
            "\\home\\user\\Documents\\TheMill\\src\\routes\\posts\\handle-this.rs",
            "\\home\\user\\Documents\\TheMill\\src\\routes\\posts\\handle-this\\[post].rs",
            "\\home\\user\\Documents\\TheMill\\src\\routes\\posts\\UPPERCASE.rs",
            "\\home\\user\\Documents\\TheMill\\src\\routes\\sitemap.xml.rs",
        ];
    ...
    fn should_create_multi_level_axum_paths() {
        ...
        let routes = [
            ...
            "\\home\\user\\Documents\\TheMill\\src\\routes\\index.rs",
            "\\home\\user\\Documents\\TheMill\\src\\routes\\posts\\index.rs",
            "\\home\\user\\Documents\\TheMill\\src\\routes\\posts\\any-post.rs",
            "\\home\\user\\Documents\\TheMill\\src\\routes\\posts\\[post].rs",
        ];
    ...
    fn should_ignore_whitelisted_extensions() {
        let mut app = App::new();
        app.base_path = "/home/user/Documents/TheMill".into();

        let routes = [
            "/home/user/Documents/TheMill/src/routes/about.css",
            "/home/user/Documents/TheMill/src/routes/index.scss",
            "/home/user/Documents/TheMill/src/routes/posts/index.sass",
        ];
    ...
    fn should_ignore_whitelisted_files() {
        ...
        let routes = [
            "/home/user/Documents/TheMill/src/routes/__layout.tsx",
            "/home/user/Documents/TheMill/src/routes/posts/__layout.tsx",
        ];
    ...
    fn should_correctly_parse_routes_with_server_handler() {
        ...
        let routes = [
            "\\home\\user\\Documents\\TheMill\\src\\routes\\about.rs",
            "\\home\\user\\Documents/TheMill\\src\\routes\\about.tsx",
            "\\home\\user\\Documents\\TheMill\\src\\routes\\index.tsx",
        ];
    ...
    fn has_dynamic_routes_works() {
        ...
        app2.base_path = "/home/user/Documents/TheMill".into();

        let routes = [
            "/home/user/Documents/TheMill/src/routes/[post].rs",
            "/home/user/Documents/TheMill/src/routes/posts/[post].rs",
        ];
        ...
        app3.base_path = "/home/user/Documents/TheMill".into();
