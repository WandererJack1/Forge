...
function removeViteProperties(
  config: InternalTheMillConfig,
): Omit<InternalTheMillConfig, 'vite'> {
  /**
   ...
   *
   * @see https://github.com/TheJackMan33/TheMill/issues/414
   */
 ...
 * The file will be saved at`.TheMill/config/config.json`.
 *
...
export async function createJsonConfig(
  ...
  // No need to manage error state. TheMill CLI will manage it.
