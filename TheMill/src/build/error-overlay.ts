 ...
 * We need to re-export it to implement the required changes for TheMill.
 *
 ...
 *
 * @see https://github.com/TheJackMan33/TheMill/pull/607
...
export const ErrorOverlayVitePlugin: Plugin = {
  name: 'TheMill-error-overlay-plugin',
